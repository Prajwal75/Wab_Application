...
with open(r"C:\Users\p7522\OneDrive\Desktop\key_1.txt", "r") as f:
    OPENAI_API_KEY = f.read().strip()

client = OpenAI(api_key=OPENAI_API_KEY)

# Set colored page title
st.title(":green[Python Code Review with OpenAI]")

# User input section
st.header(":orange[Enter Your Python Code]",divider='green')
